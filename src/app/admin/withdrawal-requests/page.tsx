...
import { updateWithdrawalRequestStatus } from "@/app/actions";
...
export default function WithdrawalRequestsPage() {
  ...
  useEffect(() => {
    if (userProfile?.role === "admin") {
      ...
      const unsubscribe = onSnapshot(q, (snapshot) => {
        const requestsData = snapshot.docs.map(doc => doc.data() as WithdrawalRequest);
  ...
  const renderRequestsTable = (filteredRequests: WithdrawalRequest[]) => {
