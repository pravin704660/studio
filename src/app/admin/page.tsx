...
import { Users, Swords, Wallet, Bell, Trophy, Award, Settings, ArrowDownUp } from "lucide-react";
                ...
                <Link href="/admin/wallet-requests">
                 ...
                 <Link href="/admin/withdrawal-requests">
                  <Card className="cursor-pointer transition-colors hover:border-primary">
                      ...
                      <CardContent>
                          <p className="text-xs text-muted-foreground">Manage user withdrawal requests.</p>
                      </CardContent>
                  </Card>
                </Link>
